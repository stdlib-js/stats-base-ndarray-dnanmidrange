...
var dnanmidrange = require( './../lib/main.js' );
...
tape( 'the function has an arity of 1', function test( t ) {
	t.strictEqual( dnanmidrange.length, 1, 'has expected arity' );
	t.end();
});
